...
#read data
#########################################################
setwd('/Users/YuLiang/Desktop/NUS/Sem 8/EC4304/Group/R2/R2/data')
...
###RandomWalk
#forecast horizon 1 day, 1 week, 2 week

randwalk1a=rwf.rolling.window(Y,nprev,h=1)
randwalk1a$pred
write.csv(randwalk1a$pred,'randw1step_pred.csv')
randwalk7a=rwf.rolling.window(Y,nprev,h=7)
randwalk7a$pred
randwalk7a$model
write.csv(randwalk7a$pred,'randw7step_pred.csv')
randwalk14a=rwf.rolling.window(Y,nprev,h=14)
randwalk14a$pred

randwalk1a.mse1=randwalk1a$errors[2]
write.csv(randwalk1a$errors,'randw1step_errors.csv')
randwalk7a.mse7=randwalk7a$errors[2]
write.csv(randwalk7a$errors,'randw7step_errors.csv')
randwalk14a.mse14=randwalk14a$errors[2]
write.csv(randwalk14a$errors,'randw14step_errors.csv')


randwalk1a.rmse1=randwalk1a$errors[2]
write.csv(randwalk1a$errors,'randw1step_errors.csv')
randwalk7a.rmse7=randwalk7a$errors[2]
write.csv(randwalk7a$errors,'randw7step_errors.csv')
randwalk14a.rmse14=randwalk14a$errors[2]
write.csv(randwalk14a$errors,'randw14step_errors.csv')
